...
import gg.sona.recast.protocol.DisplayScoreboard
import gg.sona.recast.protocol.ScoreboardObjective
import gg.sona.recast.protocol.Teams
import gg.sona.recast.protocol.UpdateScore
...
class ShadowScoreboard {
    ...
    fun teamOf(member: String): Team? = teams.values.firstOrNull { member in it.members }

    fun sidebar(): Objective? = displaySlots[DisplayScoreboard.SIDEBAR]?.let { objectives[it] }
