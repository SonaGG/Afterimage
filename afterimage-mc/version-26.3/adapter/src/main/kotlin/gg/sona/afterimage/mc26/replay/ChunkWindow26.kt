...
class ChunkWindow26(private val minecraft: Minecraft) {
    private val scratch = ArrayList<Packet<*>>()
    private var frame = 0
    private var lastCenterX = Int.MIN_VALUE
    private var lastCenterZ = Int.MIN_VALUE

    fun update(replay: ReplaySession, mirror: VirtualConnection26, cameraX: Double, cameraZ: Double) {
    ...
    private fun deliver(shadow: gg.sona.afterimage.mc26.state.ShadowClient26, mirror: VirtualConnection26, packet: Packet<*>, nanos: Long) {
