...
import gg.sona.afterimage.mc26.mixin.LivingEntityDataIdsAccessor
...
class ShadowEntity26(val add: ClientboundAddEntityPacket, override val spawnedAtNanos: Long, val spawnHash: Long) : EntityState {
