...
object SwingState26 {
    ...
    fun duration(effects: Collection<ShadowEffect26>, nanos: Long, animation: SwingAnimation = SwingAnimation.DEFAULT): Int {
    ...
    fun apply(entity: LivingEntity, swings: ShadowSwings26, effects: Collection<ShadowEffect26>, lastTick: Long) {
