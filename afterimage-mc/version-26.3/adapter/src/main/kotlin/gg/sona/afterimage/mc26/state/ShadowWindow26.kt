...
class ShadowWindow26(val id: Int, val open: ClientboundOpenScreenPacket?, val mount: ClientboundMountScreenOpenPacket?, val openedAtNanos: Long) {
    ...
    fun sameLayout(other: ShadowWindow26?): Boolean = other != null && other.id == id && other.type == type && other.openedAtNanos == openedAtNanos
}
