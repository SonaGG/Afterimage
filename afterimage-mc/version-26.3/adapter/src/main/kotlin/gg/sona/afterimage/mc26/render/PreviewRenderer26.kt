...
import gg.sona.afterimage.mc26.McGfx26.makeOpaque
import gg.sona.afterimage.mc26.gfx.RpTexture
import gg.sona.afterimage.mc26.mixin.CameraAccessor
import gg.sona.afterimage.mc26.mixin.CloudRendererAccessor
import gg.sona.afterimage.mc26.mixin.GameRendererAccessor
import gg.sona.afterimage.mc26.mixin.LevelExtractorAccessor
...
import gg.sona.afterimage.mc26.replay.CameraDriver26
import gg.sona.afterimage.mc26.replay.ReplayCameraEntity26
import gg.sona.afterimage.mc26.replay.VisualsController26
...
class PreviewRenderer26(private val minecraft: Minecraft, private val camera: CameraDriver26) {
    private val logger = LoggerFactory.getLogger("Afterimage")
    private val gfx = McGfx26.gfx
    var visuals: VisualsController26? = null
    ...
    private var entity: ReplayCameraEntity26? = null
    ...
    fun onFrameEnd(exporting: Boolean) {
        ...
        val previewEntity = entity?.takeIf { it.level() === level } ?: ReplayCameraEntity26(level).also { entity = it }
