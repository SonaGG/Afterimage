...
class SeekRestorer26(
    ...
    fun prepare(replay: ReplaySession, mirror: VirtualConnection26, settleNanos: Long) {
    ...
    fun restore(replay: ReplaySession, mirror: VirtualConnection26) {
    ...
    private fun rebuildParticles(replay: ReplaySession, mirror: VirtualConnection26, position: Long, lastTick: Long, windowNanos: Long) {
        ...
        val events = replay.packetsBetween(from, position) { Protocol26.INSTANCE.isVisualEvent(it) }
