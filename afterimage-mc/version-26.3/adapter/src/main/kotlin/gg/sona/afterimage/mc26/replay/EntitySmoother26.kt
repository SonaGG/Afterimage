...
import gg.sona.afterimage.mc26.state.ShadowEntity26
...
internal val ReplaySession.shadow26: ShadowClient26 get() = state as ShadowClient26

class EntitySmoother26(private val minecraft: Minecraft, private val settings: CameraSettings) {
    ...
    private fun smoothable(entity: ShadowEntity26): Boolean {
