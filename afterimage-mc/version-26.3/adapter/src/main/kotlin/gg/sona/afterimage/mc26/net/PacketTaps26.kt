package gg.sona.afterimage.mc26.net

import gg.sona.afterimage.capture.packet.PacketSink
import gg.sona.afterimage.mc26.mixin.PacketDecoderAccessor
import gg.sona.afterimage.mc26.mixin.PacketEncoderAccessor
...
object PacketTaps26 {
    ...
    fun capture(sink: PacketSink, direction: PacketDirection, frame: ByteBuf, configuration: Boolean) {
        ...
        val id = VarInts.value(packed) or (if (configuration) PacketIds26.CONFIGURATION_FLAG else 0)
