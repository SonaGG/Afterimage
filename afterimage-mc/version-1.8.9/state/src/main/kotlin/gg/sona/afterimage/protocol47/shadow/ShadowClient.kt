...
import gg.sona.afterimage.protocol47.PacketEvents47
import gg.sona.afterimage.protocol47.diff.SnapshotEncoder
...
class ShadowClient(identity: RecorderIdentity = RecorderIdentity.UNKNOWN) : ReplayState {
    ...
    override fun apply(packet: CapturedPacket, events: WorldEventSink?) {
        ...
        PacketEvents47.before(decoded, this, packet.timestampNanos, events)
        apply(decoded, packet.timestampNanos)
        PacketEvents47.after(decoded, this, packet.timestampNanos, events)
    }
