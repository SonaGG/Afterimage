...
import gg.sona.afterimage.mc189.protocol.McGameNames
import gg.sona.afterimage.mc189.protocol.toRef
...
object PacketEvents {
    ...
    fun after(packet: PlayPacket, client: ShadowClient, nanos: Long, sink: WorldEventSink) {
        ...
        when (packet) {
            ...
            is EntityEffect -> sink.onEvent(WorldEvent.EffectApplied(nanos, packet.entityId, packet.effectId, McGameNames.INSTANCE.effectLabel(packet.effectId)))
