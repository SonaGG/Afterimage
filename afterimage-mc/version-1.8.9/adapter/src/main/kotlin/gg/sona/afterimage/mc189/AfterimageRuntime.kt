...
import gg.sona.afterimage.mc189.replay.SpriteClock
import gg.sona.afterimage.mc189.replay.shadow
import gg.sona.afterimage.mc189.replay.VisualsController
import gg.sona.afterimage.mc189.render.PreviewRenderer
import gg.sona.afterimage.mc189.replay.PackDriver
import gg.sona.afterimage.mc189.replay.CameraDriver
import gg.sona.afterimage.mc189.replay.ChunkWorkers
import gg.sona.afterimage.mc189.render.GizmoRenderer
import gg.sona.afterimage.mc189.ui.ExportScreen
import gg.sona.afterimage.mc189.replay.ViewportPicker
import gg.sona.afterimage.mc189.replay.SeekRestorer
import gg.sona.afterimage.mc189.replay.ScreenMirror
import gg.sona.afterimage.mc189.replay.ReplayController
import gg.sona.afterimage.mc189.render.LookPreview
import gg.sona.afterimage.mc189.render.McExportPlatform
import gg.sona.afterimage.mc189.replay.SoundCapture
import gg.sona.afterimage.mc.common.FrameExporter
import gg.sona.afterimage.mc.common.ImageTextures
import gg.sona.afterimage.mc.common.ReplayClock
import gg.sona.afterimage.mc.common.ThumbnailService

import gg.sona.afterimage.mc.common.SdlWindow
import gg.sona.afterimage.mc.common.AfterimageSettings
import gg.sona.afterimage.mc.common.DeterministicRandom
...
import gg.sona.afterimage.mc189.ui.McWorkspaceScreens
...
class AfterimageRuntime(val minecraft: Minecraft) : EditorHost {
    ...
    val exporter = FrameExporter(McExportPlatform(minecraft), exports, { replayer.session }, cameraDriver, workspace, ffmpeg, post, SoundCapture(minecraft))
    ...
    init {
        SdlWindow.display = LenisDisplay
    ...
    fun onTimerAdvanced(timer: TickTimer) {
        ...
        timer.partialTick = partial
        timer.tickDelta = partial
