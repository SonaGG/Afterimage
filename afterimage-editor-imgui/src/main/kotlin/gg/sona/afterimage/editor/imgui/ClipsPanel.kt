...
import gg.sona.afterimage.editor.commands.RemoveClip
            ...
            for (clip in visible) {
                ...
                try {
                    ...
                    if (ImGui.beginPopupContextItem("clip-menu")) {
                        ...
                        if (Menus.item("Set in/out to clip")) session.execute(
                            SetInOutPoints(
                                clip.startNanos,
                                clip.endNanos
                            )
                        ...
                        ImGui.separator()
                        if (Menus.item("Bake to file")) ClipActions.bake(context, clip)
                        if (Menus.item("Export video")) ClipActions.export(context, clip)
                        ImGui.separator()
                        if (Menus.item("Delete")) confirmDelete = clip.id
                        ImGui.endPopup()
                    }
                    ImGui.sameLine()
                    ...
                    if (Widgets.iconButton(
                            ...
                            Icon.FILM,
                            ACTION,
                            "Bake to a standalone .afterimage file"
                        )
