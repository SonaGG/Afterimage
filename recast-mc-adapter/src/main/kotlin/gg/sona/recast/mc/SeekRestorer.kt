...
import gg.sona.recast.replay.state.shadow.SwingState
...
class SeekRestorer(
    ...
    private val sounds: SoundCapture,
    ...
    fun restore(replay: ReplaySession, mirror: VirtualConnection) {
        ...
        try {
            ...
            logger.error("Recast could not restore transient state after a seek", error)
        }
    }
