...
object AfterimageFormat {
    const val EXTENSION = "aft"
    const val LEGACY_EXTENSION = "recast"

    fun isRecording(fileName: String): Boolean = fileName.endsWith(".$EXTENSION") || fileName.endsWith(".$LEGACY_EXTENSION")
    const val VERSION = 2
    ...
    object MetadataKeys {
        ...
        const val AFTERIMAGE_VERSION = "afterimage.version"
