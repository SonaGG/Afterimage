...
class FileReplaySource(private val reader: AfterimageReader, cacheSegments: Int = 64) : ReplaySource {
    ...
    companion object {
        fun open(path: Path): FileReplaySource = FileReplaySource(AfterimageReader.open(path))
    }
}