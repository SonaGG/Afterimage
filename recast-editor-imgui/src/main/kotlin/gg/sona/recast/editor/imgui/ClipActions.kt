...
import gg.sona.recast.clip.bake.BakeJob
import gg.sona.recast.clip.bake.ClipBaker
import gg.sona.recast.editor.EditorSession
import gg.sona.recast.editor.commands.SetInOutPoints
import gg.sona.recast.render.ExportRequest
import gg.sona.recast.render.ExportSettings
import gg.sona.recast.render.ExportTarget
...
object ClipActions {
    fun bake(context: EditorContext, clip: Clip) {
        ...
        val output = context.host.bakesDirectory.resolve("${safeName(clip.title)}-${clip.id.toString().take(8)}.recast")
