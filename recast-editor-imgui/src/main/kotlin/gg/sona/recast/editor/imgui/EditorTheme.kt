...
object EditorTheme {
    ...
    val APP_BG = Rgb(0x161618)
    val PANEL = Rgb(0x1F1F22)
    val PANEL_RAISED = Rgb(0x2A2A2E)
    val PANEL_SUNKEN = Rgb(0x121214)
    val HEADER = Rgb(0x242427)
    val BORDER = Rgb(0x000000, 0.5f)
    val BORDER_SOFT = Rgb(0xFFFFFF, 0.08f)
    val SEPARATOR = Rgb(0x2C2C2F)
    val GROUP = Rgb(0x26262A)
    val CONTROL = Rgb(0x2F2F33)
    val CONTROL_HOVER = Rgb(0x3B3B40)
    val CONTROL_ACTIVE = Rgb(0x4A4A4F)
    val FIELD = Rgb(0x151517)
    val TEXT = Rgb(0xF2F2F7)
    val TEXT_MUTED = Rgb(0x98989D)
    val TEXT_DIM = Rgb(0x6B6B70)
    val ACCENT = Rgb(0x0A84FF)
    val ACCENT_HOVER = Rgb(0x3D9BFF)
    val ACCENT_ACTIVE = Rgb(0x0870DA)
    val ACCENT_TEXT = Rgb(0x64B5FF)
    val TIMECODE = Rgb(0xF2F2F7)
    val RECORD = Rgb(0xFF453A)
    val WARNING = Rgb(0xFF9F0A)
    val SUCCESS = Rgb(0x30D158)
    val SELECTION = Rgb(0x0A84FF)
    val PURPLE = Rgb(0xBF5AF2)
    val TEAL = Rgb(0x64D2FF)
    val PINK = Rgb(0xFF375F)

    val AXIS_X = Rgb(0xFF453A)
    val AXIS_Y = Rgb(0x30D158)
    val AXIS_Z = Rgb(0x0A84FF)

    val RULER_BG = Rgb(0x1A1A1D)
    val LANE_A = Rgb(0x1B1B1E)
    val LANE_B = Rgb(0x1E1E21)
    val LANE_HEADER = Rgb(0x1F1F22)
    val LANE_LINE = Rgb(0x000000, 0.4f)
    val PLAYHEAD = Rgb(0x0A84FF)
    val IN_OUT = Rgb(0x9A9A9E)
    val WORK_AREA = Rgb(0xFFFFFF, 0.035f)
    val CLIP = Rgb(0x2F5A8F)
    val CLIP_HOVER = Rgb(0x3A6CA8)
    val CLIP_SELECTED = Rgb(0x4A82C4)
    val KEYFRAME_SMOOTH = Rgb(0x64D2FF)
    val KEYFRAME_LINEAR = Rgb(0xE5E5EA)
    ...
    fun apply() {
        ...
        set(ImGuiCol.HeaderActive, ACCENT.alpha(0.5f))
        set(ImGuiCol.Separator, SEPARATOR)
        set(ImGuiCol.SeparatorHovered, ACCENT.alpha(0.6f))
        set(ImGuiCol.SeparatorActive, ACCENT)
        set(ImGuiCol.ResizeGrip, Rgb(0x000000, 0f))
        set(ImGuiCol.ResizeGripHovered, ACCENT.alpha(0.5f))
        ...
        set(ImGuiCol.DockingPreview, ACCENT.alpha(0.4f))
        ...
        set(ImGuiCol.TextSelectedBg, ACCENT.alpha(0.4f))
